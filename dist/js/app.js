(() => {
    ...
    function initSliders() {
        ...
        if (document.querySelector(".swiper-articles")) new swiper_core_Swiper(".swiper-articles", {
            modules: [ Navigation, Autoplay ],
            loop: true,
            autoplay: {
                delay: 5e3
    ...
    document.addEventListener("scroll", (function() {
        ...
        illustrations.forEach(((illustration, index) => {
            ...
            const offset = window.scrollY * .02 * speed;
    ...
    document.addEventListener("scroll", (function() {
        ...
        illustrations.forEach(((illustration, index) => {
            const speed = index % 2 === 0 ? -1 : 1;
            const offset = window.scrollY * .01 * speed;
            illustration.style.transform = `translateY(${offset}px)`;
        }));
    }));
    document.addEventListener("scroll", (function() {
        ...
        illustrations.forEach(((illustration, index) => {
            const offset = window.scrollY * .01 * (index % 2 === 0 ? -1 : 1);
            illustration.style.transform = `translateY(${offset}px)`;
        }));
    }));
    document.addEventListener("scroll", (function() {
    ...
    document.addEventListener("scroll", (function() {
        ...
        if (block != null) {
            ...
            if (window.scrollY >= blockTop && window.scrollY <= blockTop + blockHeight) illustrations.forEach(((illustration, index) => {
                const offset = scrollPosition * .05 * (index % 2 === 0 ? -1 : 1);
                illustration.style.transform = `translateY(${offset}px)`;
            }));
        }
    }));
    ...
    document.addEventListener("scroll", (function() {
        ...
        if (block != null) {
            ...
            const blockHeight = block.offsetHeight;
            const scrollPosition = window.scrollY - blockTop;
            if (window.scrollY + 300 >= blockTop && window.scrollY <= blockTop + blockHeight + 300) illustrations.forEach(((illustration, index) => {
                const offset = scrollPosition * .1 * (index % 2 === 0 ? -1 : 1);
                illustration.style.transform = `translateY(${offset}px)`;
            }));
        }
    }));
